...
PROJECT = sys.argv[8]
if sys.argv[9]=='imdb':
  from Data.get_classification_data import get_imdb_data as get_data
  NUM_CLASSES = 2
elif sys.argv[9]=='agnews':
  from Data.get_classification_data import get_agnews_data as get_data
  NUM_CLASSES = 4
...
vocab_size, train_data, test_data = get_data(MAXLEN, BATCH_SIZE)
